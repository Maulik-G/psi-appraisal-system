...
public class EmailTemplateService {
  ...
  public String appraisalApproved(String employeeName, String cycleName) {
    return base(
        ...
        "Please log in to view your final rating and feedback.",
        "Once you have reviewed the results, please acknowledge receipt.",
        "Action required: View and acknowledge result");
  }

  // ── Feedback received (to employee) ──────────────────────────
  public String feedbackReceived(String employeeName, String reviewerName,
      String feedbackType) {
    return base(
        "You have received new feedback",
        employeeName,
        "<strong>" + reviewerName + "</strong> has submitted <strong>"
            + feedbackType.toLowerCase() + "</strong> feedback for your appraisal.",
        "You can view this feedback once your appraisal cycle is finalized.",
        "Peer feedback helps build a complete picture of your performance.",
        "No action required");
  }
